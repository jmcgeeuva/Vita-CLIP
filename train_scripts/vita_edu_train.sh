...
python -u -m torch.distributed.run --nproc_per_node 4 \
  ./training/train.py \
    ...
    --batch_size 256 \
    --batch_split 8 \
    --backbone_path "/home/tkg5kq/.cache/clip/ViT-B-32.pt" \
    --train_list_path trainsplit00.csv \
    --val_list_path ./testsplit00.csv \
    ...
    --text_prompt_classes_path './classes/education_classes.txt' \
